...
base_path = os.path.join(os.path.expanduser("~"), 'Portfolio/src/portfolio/Infrastructure')
...
sf_cursor.execute(lakehouse.sql['build_warehouse_structure'], num_statements=15)
...
for table_name, table_data in tables.items():
    ...
    sf_cursor.execute(lakehouse.sql['generate_stage'].format(fully_qualified_table_name, cfg['storage_account_name'], 'policy_forge', fully_qualified_table_name))
