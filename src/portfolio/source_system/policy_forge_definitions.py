...
from policy_forge_generate_source_data import generate_data
import subprocess
...
def policy_forge_replica_data_upload():
    script_path = 'Portfolio/src/portfolio/source_system/policy_forge_write_data_to_replica.sh'
    dml_script_path = 'Portfolio/src/portfolio/source_system/policy_forge_dml.sql'
